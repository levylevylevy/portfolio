  ...
  render() {
    return (
      ...
      <CenterContents>
        ...
        <p style={{color: 'primaryBlue'}} className='font-face-body'>I love art and design, having completed a conservatory visual arts education in high school, and relishing opportunities like exhibiting my art at the MoMA in the Manhattan Borough Arts Festival in NYC. I use my eye for design to inform my work in technology.</p>
        ...
        <p style={{color: 'primaryBlue'}} className='font-face-body'>When I'm not working, I'm usually planning my next trip, reading fantasy novels, drawing at my easel, baking my friends' birthday cakes, playing board games or with my cat, seeing movies (I am a proud AMC A List-er), or listening to live music.</p>
