...
{/* <RowInfo>
    ...
    <TextWrapBody className = "font-face-body">Figma, Adobe Illustrator, After Effects</TextWrapBody>
       ...
       <TextWrapBody className = "font-face-body">The fifth flow is bike maintenance. The user can view a FAQ section about thier bike. The user can also submit a help request and attach photos. If it is an emergency, there is also an option to call a help line.</TextWrapBody>
