...
import PhotoGalleryKevin from "../PhotoGalleryKevin.js";
...
class MakerKevin extends Component {
    render() {
      return (
        <>
            <WholePageContainer>
    ...
    ><SelectedButton>KEVIN Robot</SelectedButton></NavLink> 
    ...
    {/* //insert cards */}
    <Col>
    <ChangeMarginText className="font-face-navFont" style={{color: secondaryGold}}>  Kevin </ChangeMarginText>
    <p className="font-face-body" style={{color: primaryBlue}}>Created for <i>Cornerstone of Engineering </i> Course Team Project</p>    

    <p className="font-face-body" style={{color: primaryBlue}}>Kevin is a sumo competition robot, and was built with AutoCAD, Arduino, programming, laser cutting, 3D printing, circuitry, and mechanical parts. Watch Kevin avoid being pushed out of the Sumo circle below!</p>    
    <CardContainers>

    <PhotoGalleryKevin/>
</CardContainers>
  </Col>    </RowSubMenuContents>
